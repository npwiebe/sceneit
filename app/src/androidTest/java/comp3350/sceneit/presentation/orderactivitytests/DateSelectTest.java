...
public class DateSelectTest {
    ...
    public void dateSelectTest() {
        ...
        onView(withClassName(Matchers.equalTo(DatePicker.class.getName()))).perform(PickerActions.setDate(2021, 2, 26));
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.editTextCalender), withText("26/2/2021"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        editText.check(matches(withText("26/2/2021")));

        ViewInteraction textView = onView(
                allOf(withId(R.id.textViewShowings), withText("Showings for 26/2/2021"),
                        withParent(withParent(withId(android.R.id.content))),
                        isDisplayed()));
        textView.check(matches(withText("Showings for 26/2/2021")));

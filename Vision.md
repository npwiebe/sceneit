...
The app’s success is primarily measured by its ease of use. With our design, we will be able to reduce the user's cognitive workload and require less attention to complete a simple step. Therefore, our conversion rate will increase while providing good service. In addition, our loyalty program will provide our returning users with discounts for their next purchase. This will incentivise our users to use our app often and even tell family or friends about it.
